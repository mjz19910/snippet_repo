...
/** @param {NS} ns @arg {boolean} template_changed @param {string} script_file @arg {number} hacking_skill @param {Server} srv @arg {number} t */
export async function start_server_template(ns, template_changed, script_file, hacking_skill, srv, t) {
