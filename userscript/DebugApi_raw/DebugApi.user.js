...
/** @arg {import("./support/dbg/EventListenersT.js").EventListenersT} event_handler */
...
class IterExtensions
{
	...
	/** @template T @arg {T} x @returns {T extends import("./support/dbg/IteratorPrototype.js").IteratorPrototype? Object:T extends import("./support/dbg/IterableIteratorPrototype.js").IterableIteratorPrototype? import("./support/dbg/IteratorPrototype.js").IteratorPrototype:T extends IterableIterator<any>? import("./support/dbg/IterableIteratorPrototype.js").IterableIteratorPrototype:Object} */
...
class RepeatImpl_0
{
	/** @type {Map<string,Map<number,import("./support/dbg/Repeat_0.js").Repeat_0<string>>>} */
	static map=new Map;
	/** @type {Map<number,Map<number,import("./support/dbg/Repeat_0.js").Repeat_0<number>>>} */
...
{
	/** @template T @arg {T[]} arr @returns {[true, import("./support/dbg/AnyOrRepeat_0.js").AnyOrRepeat_0<T>[]]|[false,T[]]} */
	try_compress_T(arr)
	{
		/** @type {CompressState<T,import("./support/dbg/AnyOrRepeat_0.js").AnyOrRepeat_0<T>>} */
		let state=new CompressState(arr);
		for(;state.i<state.arr.length;state.i++)
		{
			let item=state.arr[state.i];
	...
	/** @template {InstanceType<U>} T @template {new (...args: any) => any} U @arg {U} _ @arg {T[]} arr @arg {import("./support/dbg/AnyOrRepeat_0.js").AnyOrRepeat_0<T>[]} ret @returns {[true, import("./support/dbg/AnyOrRepeat_0.js").AnyOrRepeat_0<T>[]]|[false,T[]]} */
...
/** @arg {import("./support/dbg/SafeFunctionPrototype.js").SafeFunctionPrototype} safe_function_prototype */
...
class IDValueImpl_0
{
	...
	/** @type {import("./support/dbg/AltPair.js").AltPair<string,number>[]} */
	arr_dual;
	/** @type {import("./support/dbg/AltPair.js").AltPair<import("./support/dbg/AnyOrRepeat_0.js").AnyOrRepeat_0<string>,import("./support/dbg/AnyOrRepeat_0.js").AnyOrRepeat_0<number>>[]} */
	arr_dual_x;
	/** @type {import("./support/dbg/AnyOrRepeat_0.js").AnyOrRepeat_0<string>[]} */
	arr_rep_str;
	/** @type {import("./support/dbg/AnyOrRepeat_0.js").AnyOrRepeat_0<number>[]} */
	arr_rep_num;
	/** @type {string[]} */
...
class CompressDual
{
	...
	/** @arg {import("./support/dbg/AltPair.js").AltPair<string,number>} item */
	...
	/** @arg {import("./support/dbg/AltPair.js").AltPair<string,number>[]} arr */
	constructor(arr)
	{
		this.i=0;
		this.arr=arr;
...
//#region is_helpers
/** @template {{}|null} T @template {string} U @arg {import("./support/dbg/CM.js").CM<T>|null} x @arg {U} k @returns {x is import("./support/dbg/CM.js").CM<T&Record<U,string>>} */
...
/** @template T @template {string} U @arg {import("./support/dbg/CM.js").CM<MessageEvent<T>>} x @arg {U} k @returns {x is import("./support/dbg/CM.js").CM<MessageEvent<T>&MessageEvent<Record<U,unknown>>>} */
...
/** @template T @arg {import("./support/dbg/CM.js").CM<T>|null} x @returns {x is import("./support/dbg/CM.js").CM<T&{}>} */
...
//#region cast_monad
/** @template T @arg {T} x @returns {import("./support/dbg/CM.js").CM<T>} */
function new_cast_monad(x) {return {type: "cast",data: x};}

/** @template T @arg {import("./support/dbg/CM.js").CM<T>|null} x @returns {import("./support/dbg/CM.js").CM<T&{}|null>|null} */
...
/** @template T @arg {import("./support/dbg/CM.js").CM<T>|null} x @returns {import("./support/dbg/CM.js").CM<T&{type:string}>|null} */
...
/** @template T @arg {import("./support/dbg/CM.js").CM<MessageEvent<T>>|null} x @returns {x is import("./support/dbg/CM.js").CM<MessageEvent<T&{}>>} */
...
/** @template T @arg {import("./support/dbg/CM.js").CM<MessageEvent<T>>|null} x @returns {import("./support/dbg/CM.js").CM<MessageEvent<T&{}>>|null} */
function cast_to_object_msg(x)
{
	if(!is_object_msg(x)) return null;
	return x;
}
/** @template {{}} T @template {string} U @arg {import("./support/dbg/CM.js").CM<MessageEvent<T>>} x @arg {U} k @returns {x is import("./support/dbg/CM.js").CM<MessageEvent<T&Record<U,string>>>} */
...
/** @template T @arg {import("./support/dbg/CM.js").CM<MessageEvent<T>>|null} x @returns {import("./support/dbg/CM.js").CM<MessageEvent<T&{type:string}>>|null} */
...
/** @template {import("./support/dbg/CM.js").CM<MessageEvent<any>>} T @arg {T} x @returns {import("./support/dbg/CM.js").CM<MessageEvent<T["data"]["data"]&{data:unknown}>>|null} */
function cast_to_record_with_string_type_msg_data(x)
{
	if(!is_record_with_T_msg_m(x,"data")) return null;
	/** @type {import("./support/dbg/CM.js").CM<MessageEvent<T&{data:unknown}>>} */
	let xr=x;
	return xr;
}

/** @arg {import("./support/dbg/CM.js").CM<MessageEvent<{type:string,data:unknown}>>} x @returns {x is import("./support/dbg/CM.js").CM<MessageEvent<import("./support/dbg/WrappedMessage.js").WrappedMessage<unknown>>>} */
...
/** @arg {import("./support/dbg/CM.js").CM<MessageEvent<{type:string,data:unknown}>>} x @returns {import("./support/dbg/CM.js").CM<MessageEvent<import("./support/dbg/WrappedMessage.js").WrappedMessage<unknown>>>|null} */
...
/** @template {string} U @template {{}} T @arg {import("./support/dbg/CM.js").CM<T>|null} x @arg {U} k @returns {import("./support/dbg/CM.js").CM<T&{[P in U]:string}>|null} */
...
class TCPMessage
{
	...
	constructor(flags,client_id,seq,ack,data)
	{
		...
		this.seq=seq;
		this.ack=ack;
		/** @type {import("./support/dbg/ConnectionMessage.js").ConnectionMessage["data"]} */
		this.data=data;
	}
	/** @arg {number} client_id @returns {import("./support/dbg/ConnectionMessage.js").ConnectionMessage} */
...
class Socket
{
	...
	/** @arg {import("./support/dbg/ConnectionMessage.js").ConnectionMessage} data @arg {[MessagePort]} ports */
	...
	{
		/** @type {import("./support/dbg/WrappedMessage.js").WrappedMessage<import("./support/dbg/ConnectionMessage.js").ConnectionMessage>} */
		let msg={
	...
	/** @arg {import("./support/dbg/ConnectionMessage.js").ConnectionMessage} data */
	...
	/** @arg {import("./support/dbg/ConnectionMessage.js").ConnectionMessage} message */
	client_connect(message) {if(testing_tcp) {console.log("on_client_connect",message,this.m_event_source);} }
	/** @arg {MessageEvent<import("./support/dbg/ConnectionMessage.js").ConnectionMessage>} event */
	handleEvent(event)
	{
	...
	/** @arg {import("./support/dbg/ConnectionMessage.js").ConnectionMessage} tcp_message */
...
{
	static direct_message=false;
	/** @private @type {import("./support/dbg/ConnectionSide.js").ConnectionSide} */
	m_side="server";
	/** @private @type {import("./support/dbg/ConnectionMessage.js").ConnectionMessage[]} */
	m_unhandled_events=[];
	/** @private */
	...
	/** @arg {import("./support/dbg/ConnectionMessage.js").ConnectionMessage} info */
...
class CrossOriginConnection
{
	...
	on_message_event(event_0)
	{
		...
		/** @type {import("./support/dbg/msg_ev_01.js").msg_ev_01} */
	...
	/** @arg {MessageEvent<unknown>} event @returns {event is MessageEvent<import("./support/dbg/WrappedMessage.js").WrappedMessage<unknown>>} */
	...
	/** @arg {MessageEvent<unknown>} event @returns {event is MessageEvent<import("./support/dbg/WrappedMessage.js").WrappedMessage<import("./support/dbg/ConnectionMessage.js").ConnectionMessage>>} */
	...
	/** @template {import("./support/dbg/CM.js").CM<{type:string}>} T @arg {T} data @returns {data is T&import("./support/dbg/CM.js").CM<{type:string,data:unknown}>} */
...
class DebugApi
{
	...
	/** @arg {"__k"} key @returns {import("./support/dbg/dbg_get_ty.js").dbg_get_ty} */
	get_k(key) {return this.getData(key);}
	/** @returns {import("./support/dbg/I_debug.js").I_debug} */
	get_d() {return this.getData("d");}
	/** @arg {"getEventListeners"} key @returns {(x:{})=>{[x: string]: import("./support/dbg/EventListenerInternal.js").EventListenerInternal[]}} */
	...
	/** @arg {any} element @returns {{[x: string]: import("./support/dbg/EventListenerInternal.js").EventListenerInternal[]}} */
	...
	/** @arg {import("./support/dbg/I_debug.js").I_debug} debug @arg {import("./support/dbg/I_undebug.js").I_undebug} undebug @arg {import("./support/types/Constructor.js").Constructor} func @arg {string} name @returns {import("./__global.js").dbg_result} */
	get_event_listener_var_vec_1(debug,undebug,func,name)
	{
		this.attach(debug,undebug,null);
		/** @arg {import("./support/types/Constructor.js").Constructor} func @arg {any} f_this @arg {any[]} c_args */
	...
	/** @arg {import("./support/dbg/IDebugBreakpointArgs.js").IDebugBreakpointArgs} breakpoint_arguments @returns {import("./__global.js").dbg_result} */
	debuggerGetVarArray_a(breakpoint_arguments)
	{
		...
		let tmp_key="__k";
		/** @type {import("./support/dbg/dbg_get_ty.js").dbg_get_ty} */
		let tmp_value={};
	...
	/** @arg {import("./support/types/Constructor.js").Constructor} class_value @arg {[any,any[]]} activate_args @arg {string} var_match @returns {import("./__global.js").dbg_result} */
	...
	/** @arg {(...x: any[]) => void} function_value @arg {[any, any[]]} activate_args @arg {string} var_match @returns {import("./__global.js").dbg_result} */
	...
	debuggerGetVar_a(breakpoint_arguments)
	{
		...
		this.setData(tmp_key,tmp_value);
		/** @type {import("./support/dbg/I_debug.js").I_debug} */
	...
	/** @arg {import("./support/types/Constructor.js").Constructor} class_value @arg {any[]} activate_args @arg {string} var_name @returns {import("./__global.js").dbg_result} */
	...
	/** @arg {(...x: any[]) => void} function_value @arg {[any, any[]]} activate_vec @arg {string} var_name @returns {import("./__global.js").dbg_result} */
