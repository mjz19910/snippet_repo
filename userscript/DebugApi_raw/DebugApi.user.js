...
/** @type {import("./support/dbg/SavedInstanceType.js").SavedInstanceType[]} */
...
function add_object_with_name(name, object) {
  /** @type {import("./support/dbg/MetaTagForPrototypeOf.js").MetaTagForPrototypeOf} */
  const instance_meta = {
  ...
  /** @type {import("./support/dbg/SavedInstanceSubType.js").SavedInstanceSubType} */
...
function add_object(constructor_, object) {
  ...
  /** @type {import("./support/dbg/MetaTagForConstructor.js").MetaTagForConstructor} */
  const instance_meta = {
...
class Socket {
  ...
  handleEvent(event) {
    ...
    if (testing_tcp) {
      console.groupCollapsed(
        "-rx-S?-> Socket<" + data.seq + "," + data.ack + "," + data.flags + ">",
      );
...
class ListenSocket {
  ...
  push_tcp_message(data) {
    if (testing_tcp) {
      console.groupCollapsed(
        "-tx-S-> ListenSocket<" + data.seq + "," + data.ack + ">",
      );
      console.log("ListenSocket ->");
      console.log("s_port.onmessage.handleEvent ->");
  ...
  handleEvent(event) {
    ...
    if (testing_tcp) {
      console.groupCollapsed(
        "-rx-L?-> ListenSocket<" + data.seq + "," + data.ack + ">",
      );
      console.log("Socket ->");
      console.log("l_port.onmessage.handleEvent ->");
...
class CrossOriginConnection {
  ...
  on_message_event(event_0) {
    ...
    if (testing_tcp) {
      console.groupCollapsed(
        "-rx-C!-> CrossOriginConnection<" + event_0.data.data.seq + "," +
          event_0.data.data.ack + ">",
      );
