...
export namespace Prelude {
	...
	export type CF_RS_Page_Type1="CF_RS_Page_Type1";
	export type CF_T_Commands="CF_T_Commands";
	export type CF_T_Endpoint="CF_T_Endpoint";
	export type CF_T_GM="CF_T_GM";
	export type CF_T_Icon_Any="CF_T_Icon_Any";
...
export namespace Types {
	...
	export type CF_RS_Page_Type1_=CF_RS_Page_Type1;
	export type CF_T_Commands_=CF_T_Commands;
	export type CF_T_Endpoint_=CF_T_Endpoint;
	export type CF_T_GM_=CF_T_GM;
	export type CF_T_Icon_=CF_T_Icon;
