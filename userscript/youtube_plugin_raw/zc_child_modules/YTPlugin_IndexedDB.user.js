...
class IndexedDBService extends BaseService {
	...
	/** @template T @typedef {import("../yt_json_types/m/make_item_group.ts") .make_item_group<T>} make_item_group */
	...
	/** @template T @arg {make_item_group<T>} x @returns {boolean} @arg {import("../yt_json_types/stu/group_T.ts").T_GetTypeof<T>} ty */
	 ...
	 * @param {IDBDatabase} db @arg {string} storeNames @arg {IDBTransactionMode} mode
	 * @param {()=>void} complete_cb
	 */
	open_transaction(typed_db, db, storeNames, mode, complete_cb) {
		const tx = typed_db.transaction(db, storeNames, mode);
	...
	/** @arg {TypedIndexedDB} typed_db @arg {IDBDatabase} db @arg {string} storeNames @arg {IDBTransactionMode} mode @returns {import("../zb_plugin_types/TypedIDBTransactionScope.ts").TypedIDBTransactionScope} */
	open_transaction_scope(typed_db, db, storeNames, mode) {
		const tx = this.open_transaction(typed_db, db, storeNames, mode, () => {
