...
class ParserService extends BaseService {
	...
	/** @private @arg {D_CF_L_Params} root @arg {Extract<T_SplitOnce<ParseUrlWithSearchIn,"?">,["watch",...any]>[1]} x */
	...
	/** @api @public @arg {D_CF_L_Params} root @arg {P_ParamParse_XX} path @arg {string} x */
	...
	/** @unused_api @protected @arg {D_CF_L_Params} root @arg {P_ParamParse_XX} path @arg {string} x */
	...
	/** @private @arg {D_CF_L_Params} root @arg {P_ParamParse_XX} path @arg {ParamMapType} map */
	...
	/** @private @type {P_LogItems} */
	/** @private @arg {D_CF_L_Params} root @arg {P_ParamParse_XX} path @arg {ParamMapType} map @arg {number[]} map_keys @arg {number} map_entry_key @arg {ParamMapValue[]|undefined} map_entry_value @arg {ParseCallbackFunction|null} callback */
	...
	/** @private @arg {D_CF_L_Params} root @arg {P_ParamParse_XX} path @arg {ParamMapValue[]} tva */
	...
	/** @api @public @arg {D_CF_L_Params} root @arg {P_ParamParse_XX} path @arg {ParamMapType} map */
	...
	/** @private @type {string[]} */
	cache_player_params=[];
	/** @private @arg {D_CF_L_Params} root @arg {Extract<D_UrlFormat,`https://${string}`|`http://${string}`>} x */
	...
	/** @api @public @arg {D_CF_L_Params} root @arg {D_UrlFormat} x */
	parse_url(root,x) {
	...
	/** @private @arg {D_CF_L_Params} root @arg {NS_DP_Parse.ParseUrlStr_0} x */
	parse_url_1(root,x) {
	...
	/** @private @arg {D_CF_L_Params} root @arg {ParseUrlWithSearchIn|ParseUrlWithSearchIn_2} x */
	...
	/** @private @type {D_UrlFormat} */
	/** @private @arg {D_CF_L_Params} root @arg {Extract<T_SplitOnce<T_SplitOnce<Exclude<D_UrlFormat,"/">,"/">[1],"/">,[any]>[0]} x */
	parse_url_2(root,x) {
		if(this.str_is_search(x)) {
