...
class ECatcherService extends BaseService
{
	...
	data={
		/** @private @type {{name:import("../yt_json_types/r/group_R.js").RC_ECatcherClientName['value'];fexp:number[];version:import("../yt_json_types/r/group_R.js").RC_SomeVer<import("../yt_json_types/r/group_R.ts").RC_CsiVarTypes["cver"]>}|null} */
		client: null,
	...
	/** @api @public @arg {import("../yt_json_types/r/group_R.ts").RC_ECatcher_SPs["params"]} params */
	on_params(params)
	{
