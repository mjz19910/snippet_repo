...
class HandleTypes extends HandleTypesEval {
	...
	on_endpoint_params_callback(map_entry_values,map_entry_key_path,path,map_keys,root) {
		...
		switch(path)/*endpoint*/ {
			...
			case "D_Browse.param": switch(map_entry_key) {case 2: case 5: case 23: case 84: case 93: case 94: case 110: break; default: new_ns(); debugger; return;}return this.parse_param_next(root,`D_Browse.param.f${map_entry_key}`,map_entry_key_path,map_entry_values,callback);
			...
			case "aadc_guidelines_state_entity_key": switch(map_entry_key) {case 2: case 4: case 5: return this.parse_param_next(root,`${path}.f${map_entry_key}`,map_entry_key_path,map_entry_values,callback); default: new_ns(); debugger; return;}
			case "unsubscribe.params.f1": switch(map_entry_key) {case 1: return this.parse_param_next(root,`${path}.f${map_entry_key}`,map_entry_key_path,map_entry_values,callback); default: new_ns(); debugger; return;}
			...
			case "entity_key.normal.f2": switch(map_entry_key) {case 1: return this.parse_param_next(root,`${path}.f${map_entry_key}`,map_entry_key_path,map_entry_values,callback); default: new_ns(); debugger; return;}
	...
	D_DarkColorPalette(cf1,x) {
		...
		}
		{
			...
			switch(g) {
				...
				case 0xa3: case 0xa5: case 0xa6:
				case 0xa8: case 0xa9: case 0xaa: case 0xab: case 0xac: case 0xad: case 0xaf:
				case 0xb2: case 0xb4: case 0xb5: case 0xb7:
				case 0xb9: case 0xbc: case 0xbe:
		...
		}
		{
			...
			switch(r) {
				...
				case 0x08: case 0x0a: case 0x0c: case 0x0d:
				case 0x11: case 0x14: case 0x15:
				case 0x18: case 0x19:
			}
			switch(g) {
