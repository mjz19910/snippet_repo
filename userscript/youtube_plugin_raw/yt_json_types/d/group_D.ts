...
import {AD_AppendContinuationItems,AD_UpdateEngagementPanel} from "../abc/AD.ts";
import {GD_SD_Item} from "../abc/a_sub/G_empty_obj.ts";
import {B_Hack,B_HrefUrl,B_TagObj,B_VEMap} from "../abc/group_B.ts";
import {CD_NextRadio,CD_Reload,C_CommandExecutor,C_Continuation,C_FollowUp,C_GetPdgBuyFlow,C_GetSurvey,C_Innertube,C_RelatedChip,C_RepeatChapter,DC_ScrollToEngagementPanel,DC_SectionList_TargetId,DR_DC_EntityBatchUpdate,P_param_known_like_paths} from "../abc/group_C.ts";
import {EG_GetNotificationMenuRequest,E_AdFeedback,E_AddUpcomingEventReminder,E_CreateComment,E_CreateCommentReplyDialog,E_CreatePlaylistService,E_Feedback,E_Like,E_MuteAd,E_PerformCommentAction,E_Pinging,E_PlaylistDelete,E_PlaylistEdit,E_PlaylistEditor,E_RecordNotificationInteractions,E_RemoveUpcomingEventReminder,E_ShareEntityService,E_SignalNavigation,E_SignalService_SendPost,E_Subscribe,E_UndoFeedback,E_Unsubscribe,E_Upload,E_Url,E_UserFeedback,E_Watch,E_WatchPlaylist,E_WebPlayerShareEntityService,E_YpcGetCart,E_YpcGetOffers} from "../e/E.ts";
import {E_CreateCommentReply} from "../e/E_CreateCommentReply.ts";
import {E_Search,E_VE11487,E_VE23462,E_VE3611,E_VE37414_ReelWatch,E_VE3854,E_VE42352,E_VE5754,E_VE6827,E_VE96368} from "../e/GR_E_VE.ts";
import {D_FormatItem_SignatureCipher_SP,D_VideoPlaybackShape_S_Params,GA_MenuNavigationPopup,GE_Browse,GM_VE3854,GR_MP_MenuNotificationSection_Item,GU_CaptionTrackItem_BaseUrl,GU_ExternalUrl,GU_GoodPut_ProbeUrl,GU_InitPlaybackUrl,GU_RadioShareUrl,GU_VE11487_Url,GU_VE3611_Url,GU_VE6827_Url,GU_VE83769_Url_External,GU_VideoPlaybackUrl,GU_YTExternalUrl,GV_gen_g2_t1,GV_gen_g3_t2,G_AccountItemSection,G_AccountPageSettingsSections,G_AdPlacementRendererItem,G_BrowseFeed,G_BrowseFeedContent,G_CardList_StyleType,G_ChannelSwitcherContent,G_EngagementPanelMenu,G_FormatQuality,G_GuideSectionItem,G_GuideSubscriptionsSectionItem,G_LinearAdsItem,G_MenuItem,G_MimeTypeFormat,G_PlaylistPanel_Item,G_PlaylistSidebarItem,G_ProfileColumnItem,G_RendererContentItem,G_RichGridContent,G_RichItemContent,G_RichSection,G_SI_DB_EngagementPanel,G_SecondaryContents,G_SettingItemIdEnum,G_SettingsOptionItem,G_StructuredDescriptionContentItem,G_Text,G_ThumbnailOverlayItem,G_TopbarButtonItem,G_WatchNextEndScreenItem,G_YtWatchUrl,S_PageTypeStr} from "../ghi/group_G.ts";
import {K_AccountLinkProviderKey} from "../k/K.ts";
import {MG_AdLayout,MG_AdLayout_DisplayBillboardImageButtoned,M_AccountMenu,M_Empty_WCM,M_Feedback,M_GetUnseenNotificationCount} from "../m/M.ts";
import {V_BinaryTimestamp} from "../nop_q/P.ts";
import {A_FancyDismissibleDialog,MP_LoadingAccountMenu,MP_LoadingNotificationMenu,Popup_DL_ConfirmDialog,Popup_DL_DismissibleDialog,R_TopbarMenu,TA_OpenPopup_Empty} from "../nop_q/Popup.ts";
import {RA_Notification,RC_CsiServiceC,RC_CsiServiceCVer,RC_CsiVarMap,RG_Result,RMD_Badge,RMD_RowContainer,RS_Search,R_AccountSectionList,R_AdDurationRemaining,R_AdHoverTextButton,R_AdPlacementConfig,R_AdPreview,R_AdSlot,R_AddToPlaylistCreate,R_AttachmentElement,R_AuthorCommentBadge,R_AutoplaySwitchButton,R_BasicColorPaletteData,R_BrowserMediaSessionRenderer,R_Card,R_CarouselLockup,R_ChannelHeaderLinks,R_ChannelSwitcherHeader,R_ChannelThumbnailWithLink,R_Chapter,R_ChildVideo,R_ChipCloud,R_ChipCloudChip,R_CinematicContainer,R_ClipAdState,R_ClipCreation,R_ClipCreationScrubber,R_ClipCreationTextInput,R_Comment,R_CommentActionButtons,R_CommentSimplebox,R_CommentsEntryPointTeaser,R_CommentsHeader,R_CompactLink,R_CompactVideo,R_ContinuationItem,R_DecoratedPlayerBar,R_DescriptionChaptersItem,R_DisplayAd,R_DownloadButton,R_Dropdown,R_DropdownFormField,R_ElementUpdate,R_EmojiPicker,R_EndscreenElement,R_EngagementPanelSectionList,R_ExpandableSurveyResponse,R_Factoid,R_FeedFilterChipBar,R_FlyoutCta,R_FulfilledLayout,R_FusionSearchbox,R_GhostGrid,R_GuideEntry,R_GuideEntryData,R_HeatSeekerItem,R_Heatmap,R_HeroPlaylistThumbnail,R_Hint,R_HotkeyDialog,R_HotkeyDialogSection,R_HotkeyDialogSectionOption,R_InfoCardIcon,R_InfoRow,R_InstreamAdPlayerOverlay,R_LikeButton,R_LiveChatAuthorBadge,R_LiveChatHeader,R_MacroMarkersInfoItem,R_MacroMarkersListItem,R_Menu,R_MenuFlexibleItem,R_MenuNavigationItem,R_MenuServiceItem,R_MerchandiseItem,R_Message,R_MetadataRow,R_Miniplayer,R_MovingThumbnail,R_MultiMarkersPlayerBar,R_MultiPageMenuNotificationSection,R_MusicQueue,R_MusicResponsiveListItem,R_MusicShelfDivider,R_PdgBuyFlowHeader,R_PdgColorSlider,R_PdgCommentChip,R_PdgCommentOption,R_PdgCommentPreview,R_PivotButton,R_PlayerErrorMessage,R_PlayerOverlayAutoplay,R_PlayerOverlayVideoDetails,R_PlaylistAddToOption,R_PlaylistByline,R_PlaylistInfoCardContent,R_PlaylistLoopButton,R_PlaylistLoopButtonState,R_PlaylistPanel,R_PlaylistPanelVideo,R_PlaylistVideoThumbnail,R_PrivacyDropdownItem,R_ProductListItem,R_ProfileColumnStatsEntry,R_ProfilePageHeaderButtonRowViewModel,R_ProfilePageHeaderInformationViewModel,R_ProfilePageHeaderMetadataViewModel,R_ProfilePageHeaderThumbnailViewModel,R_ProfilePageHeaderTitleViewModel,R_PromotedSparklesWeb,R_RatingSurvey,R_RatingSurveyOption,R_ReelItem,R_ReelMultimixAttributionLabel,R_ReelPlayerHeader,R_ResourceStatusInResponseCheck,R_RichGrid,R_RichItem,R_RichListHeader,R_RichMetadata,R_RichMetadataRow,R_SampledThumbnailColor,R_SearchResultsTab,R_SectionList,R_SegmentedLikeDislikeButton,R_SimpleAdBadge,R_SkipAd,R_SkipButton,R_SortFilterSubMenu,R_SponsorCommentBadge,R_StructuredDescriptionPlaylistLockup,R_SubFeedOption,R_SubscribeButton,R_SubscriptionNotificationToggleButton,R_SuperVodBuyFlowContent,R_Tab,R_TemplateUpdate,R_TemplatedAdText,R_TextDecorator,R_TextInputFormField,R_ThumbnailOverlayTimeStatus,R_ThumbnailOverlayToggleButton,R_ToggleButton,R_TopbarLogo,R_TopicLink,R_TranscriptFooter,R_TranscriptSearchPanel,R_TranscriptSegment,R_TranscriptSegmentList,R_VideoInfoCardContent,R_VideoMastheadAdV3,R_VideoOwner,R_VideoViewCount,R_WatchNextEndScreen,R_WebSearchboxConfig,ToKeyValue} from "../r/group_R.ts";
import {R_BackgroundPromo} from "../r/r_sub/r/R_BackgroundPromo.ts";
import {R_CollaboratorInfoCardContent} from "../r/r_sub/r/R_CollaboratorInfoCardContent.ts";
import {R_CommentReplyDialog} from "../r/r_sub/r/R_CommentReplyDialog.ts";
import {R_DynamicReadaheadConfig} from "../r/r_sub/r/R_DynamicReadaheadConfig.ts";
import {R_EmojiPickerCategory} from "../r/r_sub/r/R_EmojiPickerCategory.ts";
import {R_EmojiPickerCategoryButton} from "../r/r_sub/r/R_EmojiPickerCategoryButton.ts";
import {R_EmojiPickerUpsellCategory} from "../r/r_sub/r/R_EmojiPickerUpsellCategory.ts";
import {R_SimpleCardContent} from "../r/r_sub/r/R_SimpleCardContent.ts";
import {R_SimpleCardTeaser} from "../r/r_sub/r/R_SimpleCardTeaser.ts";
...
//#endregion
export type D_VideoDescriptionCourseSection={
	sectionTitle: G_Text;
...
export type DT_MenuItem_Button=R_Button|R_DownloadButton;

export type DT_MenuFlexibleItem={
	menuItem: G_MenuItem_2;
	topLevelButton: DT_MenuItem_Button;
};

//#region Parsed Url (as objects)
export type DU_UrlParams_PageadParallelAdInteraction={
	ai: string;
	sigh: string;
	cid: string;
	ad_mt: "[AD_MT]";
...
//#endregion
//#region Derived Template String
export type DU_SettingsId=`SP${T_Split<G_SettingsEndpointPages,"/">[1]}`;
//#endregion
//#endregion DU
export type D_HighlightTextDecorator={
	startIndex: number;
	length: number;
	backgroundColor: number;
	backgroundCornerRadius: 8;
};
export type D_Message={
	text: G_Text;
	trackingParams: string;
};
export type DE_CreateCommentReplyDialog=T_Dialog<R_CommentReplyDialog>;
