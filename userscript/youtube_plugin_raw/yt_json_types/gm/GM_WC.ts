...
type EndpointLikeEndings="Endpoint"|"Command"|"Action";
type TE_Endpoint_3<EP_Key extends `${string}${EndpointLikeEndings}`,T_Data,T_Meta>={clickTrackingParams: string; commandMetadata: T_Meta;}&{[K in EP_Key]: T_Data};
