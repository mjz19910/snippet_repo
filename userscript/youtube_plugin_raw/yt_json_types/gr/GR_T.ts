...
type T_ExtractImport<T extends (GenNs_AllNames|import("../../zd_gen_CF/gen_export_cur.js").Gen.CF_Generated['n'])>=Extract<import("../../zd_gen_CF/gen_export_cur.js").Gen.CF_Generated,{n: T;}>['v']|T|"";
