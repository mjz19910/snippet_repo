...
type R_RatingSurvey={ratingSurveyRenderer: D_RatingSurvey;}; type R_ExpandableVideoDescriptionBody={expandableVideoDescriptionBodyRenderer: D_ExpandableVideoDescriptionBody;}; type R_GuideCollapsibleEntry={guideCollapsibleEntryRenderer: D_GuideCollapsibleEntry;}; type R_GuideCollapsibleSectionEntry={guideCollapsibleSectionEntryRenderer: D_GuideCollapsibleSectionEntry;}; type R_GuideDownloadsEntry={guideDownloadsEntryRenderer: D_GuideDownloadsEntry;};
type R_GuideEntry={guideEntryRenderer: D_GuideEntry;}; type R_PlayerOverlay={playerOverlayRenderer: D_PlayerOverlay;}; type R_PlayerOverlayAutoplay={playerOverlayAutoplayRenderer: D_PlayerOverlayAutoplay;};
