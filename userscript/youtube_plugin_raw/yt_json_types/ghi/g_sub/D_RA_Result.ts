...
type D_RA_R_YtPageSnapshot=[["child",1,Uint8Array,[["child",1,Uint8Array,null],["child",2,Uint8Array,null],["child",3,Uint8Array,null]]]];

type D_RA_D_PageSnapshotToken=[["data32",1,0],["child",2,Uint8Array,null],["child",3,Uint8Array,D_RA_V_BinaryTimestamp],["child",4,Uint8Array,D_RA_V_BinaryTimestamp]];

type D_RA_CR_0x12f639cf=[
	["data32",3,number],
...
type DD_exv_0=R_0x12f639cf;
type DD_exv_1=D_0x12f639cf;
