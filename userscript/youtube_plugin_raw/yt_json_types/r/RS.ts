...
type RS_Page_Channel={
	...
	endpoint: E_VE3611;
	response: RS_Channel;
	url: `/@${string}`|`/@${string}/videos`|`/@${string}/shorts`|`/@${string}/playlists`|`/@${string}/search?query=${string}`;
	expirationTime: number;
}|{
	rootVe: 3611;
	url: `/@${string}/videos`|`/@${string}/playlists`|`/@${string}/community`|`/@${string}/channels`|`/@${string}/about`;
	endpoint: E_VE3611;
	page: "channel";
	response: RS_Channel;
	expirationTime: number;
