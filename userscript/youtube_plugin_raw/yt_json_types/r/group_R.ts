...
import {B_Hack,B_StateTag} from "../abc/group_B.ts";
import {CD_TimedContinuation,C_AdsControlFlowOpportunityReceived,C_Continuation,C_ReloadContinuationItems,C_ResetChannelUnreadCount,DC_EntityBatchUpdate} from "../abc/group_C.ts";
import {DD_Streaming,DMD_Badge,DMD_RowContainer,DRC_CsiVarKV,DT_MenuFlexibleItem,DU_VE3832_PreconnectUrl,D_AboutThisAd,D_AccountItemSection,D_AccountLinkButton,D_AccountSettingIdList,D_ActionCompanionAd,D_AdBreakService,D_AdDurationRemaining,D_AdFeedback,D_AdHoverTextButton,D_AdPlacement,D_AdPlacementConfig,D_AdPreview,D_AdSlot,D_AddToPlaylist,D_AddToPlaylistCreate,D_AlertWithButton,D_AttBgChallenge,D_AuthorCommentBadge,D_AutoplaySwitchButton,D_BasicColorPaletteData,D_BrowseEndpointContextMusicConfig,D_BrowseEndpointPages,D_BrowseFeedActions,D_Button,D_C4TabbedHeader,D_Cache_MD,D_Card,D_CardCollection,D_CarouselLockup,D_ChannelHeaderLinks,D_ChannelOptions,D_ChannelSwitcherHeader,D_ChannelSwitcherPage,D_ChannelThumbnailWithLink,D_Channel_MD,D_Chapter,D_CheckboxSurveyOption,D_ChildVideo,D_ChipCloud,D_ChipCloudChip,D_CinematicContainer,D_ClientForecastingAd,D_ClipAdState,D_ClipCreation,D_ClipCreationScrubber,D_ClipCreationTextInput,D_ClipSection,D_Comment,D_CommentActionButtons,D_CommentSimplebox,D_CommentThread,D_CommentsEntryPointHeader,D_CommentsEntryPointTeaser,D_CommentsHeader,D_CommonConfig,D_CompactLink,D_CompactPlaylist,D_CompactRadio,D_CompactVideo,D_ConfirmDialog,D_ConnectedApp,D_ContinuationItem,D_CopyLink,D_DecoratedPlayerBar,D_DescriptionChapters,D_DesktopTopbar,D_DesktopWatchAds,D_DisplayAd,D_DownloadButton,D_DropdownFormField,D_Dropdown_Privacy,D_ElementUpdate,D_EmojiPicker,D_EndScreenPlaylist,D_EndScreenVideo,D_Endscreen,D_EndscreenElement,D_EngagementPanelSectionList,D_EngagementPanelTitleHeader,D_ExpandableSurveyResponse,D_ExpandableTab,D_ExpandableVideoDescriptionBody,D_Factoid,D_FancyDismissibleDialog,D_FeedFilterChipBar,D_FeedNudge,D_FeedTabbedHeader,D_FeedbackResponseItem,D_FlyoutCta,D_FrameworkUpdates,D_FusionSearchbox,D_GhostGrid,D_GraftedVeItem,D_GuideCollapsibleEntry,D_GuideCollapsibleSectionEntry,D_GuideDownloadsEntry,D_GuideEntry,D_GuideEntryData,D_GuideSection,D_GuideSubscriptionsSection,D_HeartbeatParams,D_HeatSeekerItemData,D_Heatmap,D_HeroPlaylistThumbnail,D_HighlightTextDecorator,D_Hint,D_HorizontalCardList,D_HotkeyDialog,D_HotkeyDialogSection,D_HotkeyDialogSectionOption,D_InFeedAdLayout,D_InfoRow,D_InlineSurvey,D_InstreamAdPlayerOverlay,D_InstreamVideoAd,D_IsCacheHit,D_ItemSectionHeader,D_ItemSection_T_Message,D_LikeButton,D_LinearAdSequence,D_LiveChat,D_LiveChatAuthorBadge,D_LiveChatHeader,D_LiveChatPlaceholderItem,D_LiveChatTextMessage,D_LiveChatViewerEngagementMessage,D_LoggingDirectives,D_MacroMarkersList,D_MacroMarkersListItem,D_Menu,D_MenuNavigationItem,D_MenuServiceItemDownload,D_MerchandiseItem,D_MerchandiseShelf,D_Message,D_MetadataRow,D_Microformat,D_Miniplayer,D_MovingThumbnail,D_MultiMarkersPlayerBar,D_MultiPageMenuNotificationSection,D_MusicCarouselShelf,D_MusicQueue,D_MusicShelf,D_MusicThumbnail,D_Notification,D_NotificationText,D_NotificationTopbarButton,D_PageIntroduction,D_PageTopAdLayout,D_PdgBuyFlow,D_PdgBuyFlowHeader,D_PdgColorSlider,D_PdgCommentChip,D_PdgCommentOption,D_PdgCommentPreview,D_PivotButton,D_PlayabilityStatus,D_PlaybackTracking,D_PlayerAnnotationsExpanded,D_PlayerAttestation,D_PlayerCaptionsTracklist,D_PlayerConfig,D_PlayerErrorMessage,D_PlayerLiveStoryboardSpec,D_PlayerMicroformat,D_PlayerOverlay,D_PlayerOverlayAutoplay,D_PlayerOverlayVideoDetails,D_PlayerStoryboardSpec,D_PlaylistAddToOption,D_PlaylistByline,D_PlaylistHeader,D_PlaylistInfoCardContent,D_PlaylistLoopButton,D_PlaylistLoopButtonState,D_PlaylistPanel,D_PlaylistPanelVideo,D_PlaylistSidebar,D_PlaylistSidebarSecondaryInfo,D_PlaylistVideoList,D_PlaylistVideoThumbnail,D_Playlist_MD,D_PrefetchHintConfig,D_PrivacyDropdownItem,D_ProductList,D_ProductListItem,D_ProfileColumn,D_ProfileColumnStats,D_ProfileColumnStatsEntry,D_ProfileColumnUserInfo,D_ProfilePageHeaderInformation,D_ProfilePageHeaderTitle,D_PromotedSparklesWeb,D_Radio,D_RadioButtonSurveyOption,D_RatingSurvey,D_RatingSurveyOption,D_ReelItem,D_ReelMultimixAttributionLabel,D_ReelPlayerHeader,D_ReelPlayerOverlay,D_ReelShelf,D_RelatedChipCloud,D_ResourceStatusInResponseCheck,D_ResultsPageUrl,D_RichGrid,D_RichItem,D_RichListHeader,D_RichMetadata,D_RichMetadataRow,D_RichSection,D_RichShelf,D_SearchBox,D_SearchPyv,D_SearchResultsTab,D_SegmentedLikeDislikeButton,D_SettingsCheckbox,D_SettingsOptions,D_SettingsRadioOption,D_SettingsSidebar,D_SettingsSwitch,D_SimpleAdBadge,D_SimpleMenuHeader,D_SkipAd,D_SkipButton,D_SortFilterSubMenu,D_SourcePivotHeader,D_SponsorCommentBadge,D_StructuredDescriptionContent,D_StructuredDescriptionPlaylistLockup,D_SubFeedOption,D_SubFeedSelector,D_SubscribeButton,D_SubscriptionNotificationToggleButton,D_SuperVodBuyFlowContent,D_Tab,D_TabbedSearchResults,D_TemplateUpdate,D_TemplatedAdText,D_TextInputFormField,D_Thumbnail,D_ThumbnailColor,D_ThumbnailOverlayBottomPanel,D_ThumbnailOverlayEndorsement,D_ThumbnailOverlayHoverText,D_ThumbnailOverlayInlineUnplayable,D_ThumbnailOverlayLoadingPreview,D_ThumbnailOverlayNowPlaying,D_ThumbnailOverlayResumePlayback,D_ThumbnailOverlaySidePanel,D_ThumbnailOverlayTimeStatus,D_ThumbnailOverlayToggleButton,D_ToggleButton,D_ToggleMenuServiceItem,D_TokenJarDefaultExpirationSeconds,D_TopbarLogo,D_TopbarMenuButton,D_TopicLink,D_TrackingParams,D_Transcript,D_TranscriptFooter,D_TranscriptSearchPanel,D_TranscriptSegment,D_TranscriptSegmentList,D_TwoColumnBrowseResults,D_TwoColumnSearchResults,D_UnifiedSharePanel,D_UserIdStr,D_Video,D_VideoDescriptionCourseSection,D_VideoDescriptionHeader,D_VideoDescriptionMusicSection,D_VideoDetails,D_VideoOwner,D_VideoPrimaryInfo,D_VideoQualityPromo,D_VideoSecondaryInfo,D_VideoViewCount,D_VoiceSearchDialog,D_VssLoggingContext,D_WatchEndpointMusicConfig,D_WatchNextEndScreen,D_WatchNextTabbedResults,D_WatchPageUrl,D_WebPrefetch,D_WebSearchboxConfig,D_YtConfig,R_InlineForm,T_IdTemplate} from "../d/group_D.ts";
import {DC_LiveChat} from "../d/group_DC.ts";
import {E_NotificationOptOut,E_RecordNotificationInteractions,E_Url,E_Watch} from "../e/E.ts";
import {E_ApplicationSettings,E_Search,E_VE23462,E_VE3611,E_VE37414_ReelWatch,E_VE3854,E_VE5754,E_VE6827,E_VE96368} from "../e/GR_E_VE.ts";
import {D_TwoColumnWatchNextResults,GA_EditPlaylist,GA_ResponseReceived,GD_RC_SectionList,GE_Browse,GE_ResponseReceived,GRC_ServiceTrackingParams,GU_VE3611_2,GU_VE3611_3,G_BrowseContents,G_BrowseHeader,G_BrowseSidebar,G_Browse_MD,G_GuideItem,G_NextContents,G_PlayerStoryboards,G_RS_Page_Playlist,G_RS_SettingsPage,G_RS_ShortsPage,G_RS_Subscribe_Action,G_RS_WatchPage,G_SE_MenuService,G_Text,G_ThumbnailOverlayItem} from "../ghi/group_G.ts";
import {A_GetSystemMenu,A_NotificationMenuPopup,A_NotificationToast,A_PdgBuyFlow,TA_OpenPopup_Empty} from "../nop_q/Popup.ts";
import {SP_GFeedbackServiceParams,SP_GoogleHelpServiceObj} from "../stu/group_S.ts";
...
export type R_PlaylistLoopButtonState={playlistLoopButtonStateRenderer: D_PlaylistLoopButtonState;};
...
export type R_AvailabilityMessage={availabilityMessage: R_Message;};
export type R_ConversationBar={conversationBarRenderer: R_AvailabilityMessage;};
export type R_ItemSection_T_Message={itemSectionRenderer: D_ItemSection_T_Message;};
export type R_ThumbnailOverlayInlineUnplayable={thumbnailOverlayInlineUnplayableRenderer: D_ThumbnailOverlayInlineUnplayable;};
export type R_AdDurationRemaining={adDurationRemainingRenderer: D_AdDurationRemaining;};
export type R_AdPreview={adPreviewRenderer: D_AdPreview;};
export type R_DownloadButton={downloadButtonRenderer: D_DownloadButton;};
export type R_FlyoutCta={flyoutCtaRenderer: D_FlyoutCta;};
export type R_InstreamAdPlayerOverlay={instreamAdPlayerOverlayRenderer: D_InstreamAdPlayerOverlay;};
export type R_MenuServiceItemDownload={menuServiceItemDownloadRenderer: D_MenuServiceItemDownload;};
export type R_SimpleAdBadge={simpleAdBadgeRenderer: D_SimpleAdBadge;};
export type R_SkipAd={skipAdRenderer: D_SkipAd;};
export type R_SkipButton={skipButtonRenderer: D_SkipButton;};
export type R_TemplatedAdText={templatedAdText: D_TemplatedAdText;};
export type R_TwoColumnWatchNextResults={twoColumnWatchNextResults: D_TwoColumnWatchNextResults;};
export type R_LiveChat={liveChatRenderer: D_LiveChat;};
export type R_HighlightTextDecorator={highlightTextDecorator: D_HighlightTextDecorator;};
export type R_TextDecorator={textDecorator: R_HighlightTextDecorator;};
export type R_PlayerErrorMessage={playerErrorMessageRenderer: D_PlayerErrorMessage;};
export type R_PlaylistInfoCardContent={playlistInfoCardContentRenderer: D_PlaylistInfoCardContent;};
