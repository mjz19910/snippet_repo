...
type MakeImportPath<T>=T extends `./DebugApi_raw/${infer BaseName1}`? `../DebugApi_raw/${BaseName1}`:T extends `./youtube_plugin_raw/zc_child_modules/${infer BaseName1}`? `./${BaseName1}`|T:T extends `./${infer BaseName}`? `./${BaseName}`:T;
