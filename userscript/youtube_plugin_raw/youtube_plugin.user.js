...
class HandleTypes extends ServiceMethods {
	...
	E_GetNotificationMenuEndpoint(x) {this.H_("E_GetNotificationMenuEndpoint",x,() => 0);}
	...
	/** @private @arg {E_SubscribeEndpoint} x */
	E_SubscribeEndpoint(x) {this.H_("E_SubscribeEndpoint",x,() => 0);}
