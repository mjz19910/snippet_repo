...
function check_item_keys(real_path,path,keys) {
	...
	switch(path) {
		default: console.log("item_keys_tag [ci_2_10_]: content path",path,real_path_arr_dyn); break;
		...
		case "itemSectionRenderer.contents[]": for(let key of keys) switch(key) {
			default: console.log("item_keys_tag [ci_3_16_]: iter content key "+path+" ["+key+"]",real_path_arr_dyn); break;
		...
		case "itemSectionRenderer": for(let key of keys) switch(key) {
			default: console.log("item_keys_tag [ci_3_17_]: iter content key "+path+" ["+key+"]",real_path_arr_dyn); break;
			case "contents": break;
			case "header": break;
		...
		case "reloadContinuationItemsCommand.continuationItems[]": for(let key of keys) switch(key) {
			default: console.log("item_keys_tag [ci_3_18_]: iter content key "+path+" ["+key+"]",real_path_arr_dyn); break;
		...
		case "reloadContinuationItemsCommand": for(let key of keys) switch(key) {
			default: console.log("item_keys_tag [ci_3_19_]: iter content key "+path+" ["+key+"]",real_path_arr_dyn); break;
			case "continuationItems": break;
			case "slot": break;
			case "targetId": break;
		} break;
