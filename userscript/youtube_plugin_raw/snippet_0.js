...
class ParserService {
	...
	/** @public @arg {CF_L_Params} root @arg {D_UrlFormat} x */
	parse_url(root,x) {root; x;}
	/** @public @arg {CF_L_Params} root @arg {P_ParamParse_XX} path @arg {string} x */
...
export class Snippet_0_tmp {
	...
	/** @public @arg {CF_L_Params} cf @arg {string} x */
	trackingParams(cf,x) {
...
class ND extends Snippet_0_tmp {
	...
	/** @private @arg {CF_L_Params} cf @template T1,T2,T3 @arg {TD_ItemSection_3<T1,T2,T3>} x @returns {[T1[],T2,T3]} */
