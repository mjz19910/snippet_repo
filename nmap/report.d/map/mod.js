...
class B {
	...
	find_duplicate() {
		...
		if (dup_count > 0 && first_dup) {
			...
			console.log(
				[...this.map.values()].map((e) => Query.stringify(e, true)).join(",\n"),
			);
...
class ams extends B {
	...
	static value = [
		...
		"ams15s29-in-f1.1e100.net",
		"ams15s30-in-f1.1e100.net",
		"ams15s33-in-f1.1e100.net",
		"ams15s40-in-f1.1e100.net",
		"ams15s41-in-f1.1e100.net",
		"ams15s42-in-f1.1e100.net",
		"ams15s44-in-f1.1e100.net",
		"ams15s48-in-f1.1e100.net",
		"ams16s21-in-f1.1e100.net",
		"ams16s22-in-f1.1e100.net",
		"ams16s29-in-f1.1e100.net",
		"ams16s30-in-f1.1e100.net",
		"ams16s31-in-f1.1e100.net",
		"ams16s32-in-f1.1e100.net",
		"ams17s08-in-f1.1e100.net",
		"ams17s09-in-f1.1e100.net",
		"ams17s10-in-f1.1e100.net",
		"ams17s12-in-f1.1e100.net",
	];
	nmap_near_27 = `
...
`;
	...
	dns_res_arr = [
		Query.A("ams15s21-in-f1.1e100.net.", 3600, IN, A, [
			IP("74.125.67.1"),
			IP("216.58.212.129"),
			IP("216.239.37.1"),
		]),
		Query.A("ams15s22-in-f1.1e100.net.", 3600, IN, A, [
			IP("74.125.67.1"),
			IP("216.58.212.161"),
			IP("216.239.37.1"),
		]),
		Query.A("ams15s29-in-f1.1e100.net.", 3400, IN, A, [
			IP("74.125.67.1"),
			IP("172.217.17.97"),
			IP("216.239.37.1"),
		]),
		Query.A("ams15s30-in-f1.1e100.net.", 3600, IN, A, [
			IP("74.125.67.1"),
			IP("172.217.17.129"),
			IP("216.239.37.1"),
		]),
		...
		Query.A("ams16s21-in-f1.1e100.net.", 3406, IN, A, [
			IP("74.125.67.1"),
			IP("216.239.37.1"),
			IP("216.58.212.193"),
		]),
		Query.A("ams16s22-in-f1.1e100.net.", 3600, IN, A, [
			IP("74.125.67.1"),
			IP("216.239.37.1"),
			IP("216.58.212.225"),
		]),
		Query.A("ams16s29-in-f1.1e100.net.", 3406, IN, A, [
			IP("74.125.67.1"),
			IP("172.217.17.33"),
			IP("216.239.37.1"),
		]),
		Query.A("ams16s30-in-f1.1e100.net.", 3315, IN, A, [
			IP("74.125.67.1"),
			IP("172.217.17.65"),
			IP("216.239.37.1"),
		]),
...
`;
	rev_arr = [""];
	dns_res_arr = [
		Query.A("arn02s05-in-f1.1e100.net.", 3600, IN, A, [
			IP("74.125.67.1"),
			IP("216.239.37.1"),
		]),
		Query.A("arn02s06-in-f1.1e100.net.", 3600, IN, A, [
			IP("74.125.67.1"),
			IP("216.239.37.1"),
		]),
		Query.A("arn06s07-in-f1.1e100.net.", 3600, IN, A, [
			IP("74.125.67.1"),
			IP("216.239.37.1"),
		]),
		Query.A("arn09s05-in-f1.1e100.net.", 3600, IN, A, [
			IP("74.125.67.1"),
			IP("216.58.209.129"),
			IP("216.239.37.1"),
		]),
		Query.A("arn09s10-in-f1.1e100.net.", 3600, IN, A, [
			IP("74.125.67.1"),
			IP("216.58.211.129"),
			IP("216.239.37.1"),
		]),
		Query.A("arn09s11-in-f1.1e100.net.", 3600, IN, A, [
			IP("74.125.67.1"),
			IP("172.217.22.161"),
			IP("216.239.37.1"),
		]),
...
class bkk extends B {
	...
	static value = [
		"02s01-in-f1.1e100.net",
		"02s02-in-f1.1e100.net",
		"02s03-in-f1.1e100.net",
		"02s04-in-f1.1e100.net",
		"03s01-in-f1.1e100.net",
		"03s02-in-f1.1e100.net",
		"03s03-in-f1.1e100.net",
	];
}
class bom extends B {
	/** @readonly*/ static key = "bom";
	static value = [
		"07s01-in-f1.1e100.net",
		"07s45-in-f1.1e100.net",
		"12s04-in-f1.1e100.net",
		"12s05-in-f1.1e100.net",
		"12s19-in-f1.1e100.net",
		"12s20-in-f1.1e100.net",
		"12s21-in-f1.1e100.net",
	];
}
class bud extends B {
	/** @readonly*/ static key = "bud";
	static value = [
		"02s22-in-f1.1e100.net",
		"02s37-in-f1.1e100.net",
		"02s38-in-f1.1e100.net",
		"02s39-in-f1.1e100.net",
	];
}
class cbf extends B {
...
class dfw extends B {
	...
	static value = [
		"25s42-in-f1.1e100.net",
		"25s43-in-f1.1e100.net",
		"25s44-in-f1.1e100.net",
		"25s46-in-f1.1e100.net",
		"25s47-in-f1.1e100.net",
		"25s48-in-f1.1e100.net",
		"28s29-in-f1.1e100.net",
		"28s30-in-f1.1e100.net",
		"28s31-in-f1.1e100.net",
		"28s34-in-f1.1e100.net",
		"28s35-in-f1.1e100.net",
	];
}
class eze extends B {
...
class iad extends B {
	...
	static value = [
		"23s04-in-f1.1e100.net",
		"23s96-in-f1.1e100.net",
		"66s01-in-f1.1e100.net",
	];
}
class kul extends B {
	...
	static value = [
		...
		"08s10-in-f1.1e100.net",
		"09s12-in-f1.1e100.net",
		"09s15-in-f1.1e100.net",
	];
}
class las extends B {
...
class lga extends B {
	...
	static value = [
		"25s77-in-f1.1e100.net",
		"25s78-in-f1.1e100.net",
		"25s79-in-f1.1e100.net",
		"25s80-in-f1.1e100.net",
		"25s81-in-f1.1e100.net",
		"34s38-in-f1.1e100.net",
		"34s39-in-f1.1e100.net",
		"34s40-in-f1.1e100.net",
	];
}
class lhr extends B {
	/** @readonly*/ static key = "lhr";
	static value = [
		"25s08-in-f1.1e100.net",
		"25s09-in-f1.1e100.net",
		"25s25-in-f1.1e100.net",
		"25s27-in-f1.1e100.net",
		"26s05-in-f1.1e100.net",
	];
}
class los extends B {
...
class mrs extends B {
	...
	static value = [
		"09s08-in-f1.1e100.net",
		"09s09-in-f1.1e100.net",
		"09s13-in-f1.1e100.net",
		"09s14-in-f1.1e100.net",
		"09s15-in-f1.1e100.net",
		"09s16-in-f1.1e100.net",
	];
}
class muc extends B {
	/** @readonly*/ static key = "muc";
	static value = [
		"11s22-in-f1.1e100.net",
		"11s23-in-f1.1e100.net",
		"12s11-in-f1.1e100.net",
		"12s12-in-f1.1e100.net",
	];
}
class nrt extends B {
	/** @readonly*/ static key = "nrt";
	static value = [
		"12s45-in-f1.1e100.net",
		"12s46-in-f1.1e100.net",
		"12s47-in-f1.1e100.net",
	];
}
class nuq extends B {
...
class par extends B {
	...
	static value = [
		"10s29-in-f1.1e100.net",
		"10s33-in-f1.1e100.net",
		"10s34-in-f1.1e100.net",
		"10s39-in-f1.1e100.net",
		"21s04-in-f1.1e100.net",
		"21s05-in-f1.1e100.net",
		"21s17-in-f1.1e100.net",
		"21s18-in-f1.1e100.net",
	];
}
class prg extends B {
	/** @readonly*/ static key = "prg";
	static value = [
		"03s10-in-f1.1e100.net",
		"03s11-in-f1.1e100.net",
		"03s12-in-f1.1e100.net",
		"03s13-in-f1.1e100.net",
	];
}
class qro extends B {
	/** @readonly*/ static key = "qro";
	static value = [
		"01s26-in-f1.1e100.net",
		"01s27-in-f1.1e100.net",
		"01s28-in-f1.1e100.net",
		"02s23-in-f1.1e100.net",
		"02s24-in-f1.1e100.net",
		"02s25-in-f1.1e100.net",
		"02s26-in-f1.1e100.net",
		"02s27-in-f1.1e100.net",
		"02s28-in-f1.1e100.net",
		"02s29-in-f1.1e100.net",
	];
}
class sea extends B {
	...
	static value = [
		"sea09s28-in-f1.1e100.net",
		"sea09s29-in-f1.1e100.net",
		"sea09s30-in-f1.1e100.net",
		"sea30s10-in-f1.1e100.net",
	];
	nmap_scan = `
...
class waw extends B {
	...
	static value = [
		"02s05-in-f1.1e100.net",
		"02s16-in-f1.1e100.net",
		"02s17-in-f1.1e100.net",
...
class yyz extends B {
	...
	static value = [
		"10s17-in-f1.1e100.net",
		"10s20-in-f1.1e100.net",
		"12s07-in-f1.1e100.net",
		"12s08-in-f1.1e100.net",
	];
}
class zrh extends B {
...
export const rev_arr_2 = (() => {
	let x = null;
	return [
		[64, 233, ["range", [[160, 171], [176, 191]]], 1],
		[66, 102, [0, 1, 12, 15], 1],
		[70, 32, [152, 154, 159], 1],
		[74, 125, ["range", [[20, 31]]], 1],
		[
			74,
			125,
			["range", [lit_value(64), [66, 71], [124, 143], [192, 207]]],
			1,
		],
		[108, 170, [192, 222, 223], 1],
		[108, 177, ["range", [[8, 15], [96, 127]]], 1],
		[
			142,
			250,
			["range", [[0, 31], [96, 99], [101, 128], lit_value(136, 138, 140, 141), [
				143,
				159,
			]]],
			1,
		...
		[
			142,
			251,
			["range", [[0, 2], [4, 6], [8, 31], [96, 126], [161, 167]]],
			1,
		],
		[172, 217, ["range", [[192, 223]]], 1],
		[172, 253, ["range", [[56, 63], [112, 127]]], 1],
		[
			173,
			194,
			["range", [
		...
		[209, 85, [
			129,
			["range", [[144, 147], [200, 203], lit_value(211), [232, 235]]],
		], 1],
		[216, 239, [32, 36, 37], 1],
	];
})();
