...
export const rev_arr_2 = (() => {
	...
	return [
		...
		[
			74,
			125,
			(x = [lit_value(64), [66, 71], [124, 143], [192, 207]], range(...x)),
			1,
		],
		...
		[
			142,
			250,
			(x = [[0, 31], [96, 99], [101, 128], lit_value(136, 138, 140, 141), [
				143,
				159,
			]],
				range(...x)),
		...
		[
			142,
			251,
			(x = [[0, 2], [4, 6], [8, 31], [96, 126], [161, 167]], range(...x)),
			1,
		],
		...
		[
			173,
			194,
			(x = [[64, 80], lit_value(104), [172, 175], [192, 224], lit_value(240)],
				range(...x)),
			1,
		],
		[199, 36, 152, 1],
		...
		[209, 85, [
			129,
			(x = [[144, 147], [200, 203], lit_value(211), [232, 235]], range(...x)),
		], 1],
		[216, 239, [32, 36, 37], 1],
	];
})();
