...
export const module_data = [[4], [function(_e, t, r) {
	"use strict";
	function n(e) {
		for(var r in e)
...
export function init() {
	...
	let do_decode = false;
	if(do_decode) {
		code = x(decode_const, 62, 145, key_array, 0, {});
	} else {
