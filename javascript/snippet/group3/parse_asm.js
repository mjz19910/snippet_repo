ar = "55 8b ec 8a 4d 08 0f b6 c1 05 4b ff ff ff 83 f8 05 77 1c ff 24 85 28 fa 9c 66 b8 10 00 00 00 5d c3 b8 20 00 00 00 5d c3 b8 40 00 00 00 5d c3 33 c0 3a 0c c5 19 b8 9f 66 72 09 3a 0c c5 1a b8 9f 66 76 0a 40 83 f8 12 72 e8 33 c0 5d c3 66 8b 04 c5 1e b8 9f 66 5d c3".split(" ");
pobj = {
	"8b": null
};
...
pobj["83"] = function(ar) {
	...
	af = num & 0x7;
	has_reg_disp = num & 0x40;
	m2 = (num >> 3) & 0x7;
	rest = (num >> 6);
	console.log("mrm8 " + af + " " + m2 + " " + rest);
	nregs.push(ar[0], ar[1], ar[2], ar[3]);
	dist = ar[2];
	if(noreg == 15) {
		val = ar[3];
...
parse_mov_2 = function(ar) {
	//8c
};
parse_lea_1 = function(ar) {
	//8d
};
parse_mov_3 = function(ar) {
	//8e
};
parse_pop_1 = function(ar) {
	//8f
};
parse_xchg = function(ar) {
	//90
	console.log("nop");
	return ar.slice(1);
};
