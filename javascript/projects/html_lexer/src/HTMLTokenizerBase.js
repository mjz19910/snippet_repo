...
export class HTMLTokenizerBase extends HTMLTokenizerImpl {
    ...
    // ----------- TODO -----------
    consume_next_if_match(_x, y) { throw new Error("TODO"); }
    create_new_token(_x) { throw new Error("TODO"); }
    insert_input_at_insertion_point() { throw new Error("TODO"); }
    insert_eof() { throw new Error("TODO"); }
    is_eof_inserted() { throw new Error("TODO"); }
    will_switch_to(_x) { console.log("todo log"); }
    will_reconsume_in(_x) { throw new Error("TODO"); }
    switch_to(_x) { throw new Error("TODO"); }
    will_emit(_x) { throw new Error("TODO"); }
    current_end_tag_token_is_appropriate() { throw new Error("TODO"); }
    consumed_as_part_of_an_attribute() { throw new Error("TODO"); }
    restore_to(_x) { throw new Error("TODO"); }
    ...
    is_ascii_lower_alpha(arg0) {
        throw new Error("Method not implemented.");
    }
    is_ascii_upper_alpha(arg0) {
        throw new Error("Method not implemented.");
    }
    to_ascii_lowercase(arg0) {
        throw new Error("Method not implemented.");
    }
    to_ascii_uppercase(arg0) {
        throw new Error("Method not implemented.");
    }
    ...
    is_ascii_alphanumeric(arg0) {
        throw new Error("Method not implemented.");
    }
    is_ascii_digit(arg0) {
        throw new Error("Method not implemented.");
    }
    is_unicode_control(m_character_reference_code) {
        throw new Error("Method not implemented.");
    }
    is_unicode_noncharacter(m_character_reference_code) {
        throw new Error("Method not implemented.");
    }
    is_unicode_surrogate(m_character_reference_code) {
        throw new Error("Method not implemented.");
    }
    is_ascii_hex_digit(arg0) {
        throw new Error("Method not implemented.");
    }
    is_ascii_space(m_character_reference_code) {
        throw new Error("Method not implemented.");
    }
}
