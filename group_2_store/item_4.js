function main() {
	...
	cur.v = function req_$sym_distance$(sym_distance) {
		...
		rust_tmp.define('unsafe read()', 'Option<T>', 'any T', function read(ptr) {
			unsafe: {
				return ptr.value;
			}
		});
		rust_tmp.define('unsafe write()', 'Option<T>', 'any T', function read(trg_ptr, value) {
			unsafe: {
				trg_ptr.value = value;
			}
		});
