...
type JsonEventResult = [type: "handle_result", from: DataItemReturn extends infer U extends DataItemReturn ? { tag: U[0] } : never, data: [results: string[], command_results: string[]]] | ["string", string[]];
