...
import {PromiseBox} from "../version_00_20/PromiseBox"
...
class BaseBox {
	...
	as_type(type: "string"|"number"|"bigint"|"boolean"|"symbol"|"undefined"|"object"|"function"): [boolean,this|null] {
...
class CSSStyleSheetConstructorBoxImpl extends BaseBox {
	...
	factory() {
		return new CSSStyleSheetBox(new this.value)
	}
