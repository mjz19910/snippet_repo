import {
	ArrayBox, AsyncFunctionBox, CSSStyleSheetBox, CSSStyleSheetConstructorBox, CSSStyleSheetInitBox, CSSStyleSheetPromiseBox, DocumentBox, EmptyArrayBox, FunctionBox, GlobalThisBox, InstructionTypeArrayBox, MediaListBox, NewableFunctionBox, NodeBox, ObjectBox, PromiseBox, StackVMBox, TemporaryBox, VoidBox, RealVoidBox, VoidPromiseBox, WindowBox,
	Box,
	InstructionHalt, InstructionReturn, InstructionBreakpoint, InstructionVMPushSelf,
	IAppendImpl, IBreakpointImpl, ICallImpl, ICastImpl, IConstructImpl, IDropImpl, IDupImpl, IGetImpl, IHaltImpl, IJeImpl, IJumpImpl, IModifyOPImpl, INopImpl, IPeekImpl, IPushWindowObjectImpl, IPushImpl, IReturnImpl, IVMBlockTraceImpl, IVMCallImpl, IVMPushArgsImpl, IVMPushIPImpl, IVMPushSelfImpl, IVMReturnImpl,
} from "./support.js";
const used_types = [
	ArrayBox, AsyncFunctionBox, CSSStyleSheetBox, CSSStyleSheetConstructorBox, CSSStyleSheetInitBox, CSSStyleSheetPromiseBox, DocumentBox, EmptyArrayBox, FunctionBox, GlobalThisBox, InstructionTypeArrayBox, MediaListBox, NewableFunctionBox, NodeBox, ObjectBox, PromiseBox, StackVMBox, TemporaryBox, VoidBox, RealVoidBox, VoidPromiseBox, WindowBox,
	Box,
